...
class ContractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract" do
    assert_difference('Contract.count') do
      post contracts_url, params: { contract: { event_id: @contract.event_id, user_id: @contract.user_id } }
    end
  ...
  test "should update contract" do
    patch contract_url(@contract), params: { contract: { event_id: @contract.event_id, user_id: @contract.user_id } }
