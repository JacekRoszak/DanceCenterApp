...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { amount: @option.amount, description: @option.description, event_id: @option.event_id, number: @option.number } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { amount: @option.amount, description: @option.description, event_id: @option.event_id, number: @option.number } }
